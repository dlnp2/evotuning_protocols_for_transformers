...
class Registry:
    ...
    def register_task_model(
        cls, task_name: str, model_name: str, model_cls: Optional[Type[ProteinModel]] = None
    ):
    ...
    def get_task_model(
        ...
        pretrained_weight_file_name: Optional[str] = None,
    ) -> ProteinModel:
        ...
        Args:
            ...
            pretrained_weight_file_name (str, optional): A file for a pretrained model weights
        Returns:
        ...
        if load_dir is not None:
            model = model_cls.from_pretrained(
                ...
                pretrained_weight_file_name=pretrained_weight_file_name,
                config=config_file,
            )
        else:
