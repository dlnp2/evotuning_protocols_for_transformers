...
class JSONDataset(Dataset):
    ...
    def __init__(self, data_file: Union[str, Path], in_memory: bool = True):
        ...
        if not isinstance(records, list):
            raise TypeError(
                f"TAPE JSONDataset requires a json serialized list, "
    ...
    def __getitem__(self, index: int):
        ...
        if not isinstance(item, dict):
            raise TypeError(
                f"Expected dataset to contain a list of dictionary "
...
class MaskedLanguageModelingDataset(Dataset):
    ...
    Args:
        ...
        in_memory (bool, optional): Whether to load the full dataset into memory.
            Default: False.
        data_file_prefix (Optional[str]): Name of the tape data file prefix.
            If this is None, the default value "pfam/pfam" is used.
            Default: None.
    """
    ...
    def __init__(
        ...
        data_file_prefix = "pfam/pfam" if data_file_prefix is None else data_file_prefix
        data_file = f"{data_file_prefix}_{split}.lmdb"
...
class RemoteHomologyDataset(Dataset):
    ...
    def collate_fn(self, batch: List[Tuple[Any, ...]]) -> Dict[str, torch.Tensor]:
        ...
        return {"input_ids": input_ids, "input_mask": input_mask, "targets": fold_label}
...
class SecondaryStructureDataset(Dataset):
    ...
    def collate_fn(self, batch: List[Tuple[Any, ...]]) -> Dict[str, torch.Tensor]:
        ...
        output = {"input_ids": input_ids, "input_mask": input_mask, "targets": ss_label}
